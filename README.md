...
`preserveTextFormatInInput()` is a short JavaScript function which persists a required prefix or suffix when the user is interacting with HTML form elements including `<input type="text">` and `<input type="url">`.
